...
def process_plots():
	plot_settings = [
		...
		['results_and_discussion/assets/interpretation/cac',
			'interpretation_cac.gp', True, ['interpretation_cac.eps']],
		...
		['results_and_discussion/assets/rna_triplex/',
			'rna_triplex_difference.gp', True, ['rna_triplex_difference.eps']],
		['results_and_discussion/assets/rna_triplex/',
			'rna_triplex_spectra.gp', True, ['rna_triplex_spectra.eps']],
		['results_and_discussion/assets/rotation_optimization/',
			'rotation_optimization.gp', True, ['rotation_optimization.eps']],
		['results_and_discussion/assets/rotation_optimization/',
			'rotation_optimization_kor.gp', True, ['rotation_optimization_kor.eps']],
