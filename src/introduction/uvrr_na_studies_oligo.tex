...
In comparison with the relaxed form, changes were seen in the \ch{C=O} and
exocyclic \ch{NH2} vibration above 1600\,\icm{}, CN stretching mode of
...
\ch{Mn^{2+}} and \ch{Ca^{2+}} ions on UV RRS (275\,nm) spectra of the LacDNA
22-mer duplex
...
related to the non-canonical structural arrangement of \ch{d(AG)10} were
