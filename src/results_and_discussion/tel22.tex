...
buffer with overall concentration 150\,mM of \ch{Na^+} ions) and their external
...
change occured ($< 1$\,min). It indicated replacement of \ch{Na^+} by
...
with the fluorescence, the samples were diluted to 200\,\g{m}M concentration,
