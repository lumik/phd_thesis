...
\input{results_and_discussion/initial_equipment}
\input{results_and_discussion/spectrograph_selection}
\input{results_and_discussion/initial_layout}
\input{results_and_discussion/focusing_lens_estimation}
\input{results_and_discussion/wavenumber_calibration}
\input{results_and_discussion/polarized_measurements}
\input{results_and_discussion/spinning_cell}
\input{results_and_discussion/multiple_excitations}
\input{results_and_discussion/backscattering}
\input{results_and_discussion/thermostated_holder}
